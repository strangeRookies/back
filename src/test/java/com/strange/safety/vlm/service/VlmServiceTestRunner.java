...
public class VlmServiceTestRunner {
    public static void main(String[] args) {
        System.out.println("=== Starting VLM Service Programmatic Test Runner ===");
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
                .selectors(selectPackage("com.strange.safety.vlm.service"))
                .build();
        ...
        System.out.println("=== VLM Service Programmatic Test Runner Finished ===");
