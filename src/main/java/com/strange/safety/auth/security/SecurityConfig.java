...
@EnableConfigurationProperties({ JwtProperties.class, RefreshTokenCookieProperties.class, CorsProperties.class })
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/scenarios",
                                                ...
                                                .hasAnyRole("INDIVIDUAL", "CORPORATE")
                                                .requestMatchers("/api/inquiries/my")
                                                .hasAnyRole("INDIVIDUAL", "CORPORATE")
                                                .requestMatchers(HttpMethod.GET, "/api/inquiries/{inquiryId}")
                                                .hasAnyRole("ADMIN", "INDIVIDUAL", "CORPORATE")
